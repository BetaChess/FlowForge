...
struct PhysicalDeviceRequirements
{
    ...
    VkPhysicalDeviceFeatures required_features = {.samplerAnisotropy = VK_TRUE};
};
...
struct QueueFamilyIndices
{
    ...
    [[nodiscard]] constexpr bool supports_present() const noexcept { return present_family_index.has_value(); }

    [[nodiscard]] constexpr bool supports_compute() const noexcept { return compute_family_index.has_value(); }

    [[nodiscard]] constexpr bool supports_transfer() const noexcept { return transfer_family_index.has_value(); }
};
...
public:
    ...
    [[nodiscard]] inline VkPhysicalDeviceProperties get_physical_device_properties() const
    {
        return physical_device_properties_;
    };
    [[nodiscard]] inline VkFormat get_depth_format() const { return depth_format_; };

    [[nodiscard]] inline const SwapchainSupportDetails &get_swapchain_support_details() const
    {
